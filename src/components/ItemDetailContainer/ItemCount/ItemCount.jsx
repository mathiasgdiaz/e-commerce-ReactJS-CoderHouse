        ...
        <div class="flex float-right w-full pl-50">
            <div class="custom-number-input h-10 w-50 ml-20">
                ...
                <div class="flex flex-row h-10 w-20 rounded-lg relative bg-transparent mt-1">
                    ...
                    <input type="number" class="outline-none focus:outline-none text-center w-full bg-gray-300 font-semibold text-md hover:text-black focus:text-black  md:text-basecursor-default flex items-center text-gray-700 outline-none" name="custom-input-number" value={unidades}></input>
                    {!stock == 0
            ...
            <div class="flex ml-5 pt-7">
                <button class="flex ml-90 text-white bg-green-500 border-0 py-2 px-6 focus:outline-none hover:bg-green-600 rounded" onClick={()=>props.onAdd({unidades})}>Agregar</button>
            </div>
        </div>
    )
}
