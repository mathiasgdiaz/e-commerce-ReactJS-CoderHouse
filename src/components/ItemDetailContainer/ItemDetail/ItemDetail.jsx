    ...
    return (
        <div class="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div class="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                <h2 class="text-sm title-font text-gray-500 tracking-widest">{categories.filter((i) => i.category === item.category)[0].text}</h2>
                ...
                <div class="p-4 border-b text-xs text-gray-700"></div>
