    ...
    return (
        <div className="lg:w-4/5 mx-auto flex flex-wrap">
            ...
            <div className="lg:w-1/2 w-full lg:pl-10 lg:py-6 mt-6 lg:mt-0">
                ...
                <div className="p-4 border-b text-xs text-gray-700"></div>
                <div className="flex border-t p-4">
                    <div className="flex pt-7">
                        <span className="title-font font-medium text-2xl text-gray-900">$ {item.price}</span>                    
                    </div>
                    <div style={{width:"250px", marginLeft:"35%"}}>
                        {!addCart ? <ItemCount stock={item.stock} onAdd={addToCart}/> : <div className="pt-7" style={{width:"250px", marginLeft:"45%"}}><button onClick={() => setBuy(true)} class="text-white bg-red-500 border-0 py-2 px-6 focus:outline-none hover:bg-red-600 rounded">Terminar Compra</button></div>}  
                    </div>
                    {buy ? <Cart open="true"/> : ''}
                </div>
            </div>
